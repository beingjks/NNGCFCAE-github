...
# base_path = r'C:\Users\胡先俊\Desktop\论文\实验数据\超参数分析\k2'
#
# auc_data = []
# aupr_data = []
#
...
# ax1.set_xlabel('k2', fontsize=12, labelpad=10)
#
# # ---- 图例（左下角） ----
...
#
# # ---- 标题 ----
# plt.title('representation dimension k2 of CAE', fontsize=14, fontweight='bold')
#
# # ---- 美化 ----
...
# ===============================
k_values = ['32', '64', '128', '256']
base_path = r'C:\Users\胡先俊\Desktop\论文\实验数据\超参数分析\dis\k2'
