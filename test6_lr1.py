...
# base_path = r'C:\Users\胡先俊\Desktop\论文\实验数据\超参数分析\lr1'
#
# auc_data = []
# aupr_data = []
#
...
# ax1.set_xlabel('lr1', fontsize=12, labelpad=10)
#
# # ---- 图例放在左下角 ----
# legend_handles = [bp_auc['boxes'][0], bp_aupr['boxes'][0]]
# legend_labels = ['AUROC', 'AUPR']
# # 左下角的坐标可微调，比如 (0.05,0.05)
# ax1.legend(legend_handles, legend_labels, fontsize=12, loc='lower left',
#            bbox_to_anchor=(0.05, 0.05), frameon=True)
#
# # ---- 标题 ----
# plt.title('Learning Rates of GCF', fontsize=14, fontweight='bold')
#
# # ---- 美化 ----
...
#     if len(vals) > 0:
#         med = np.median(vals)
#         ax1.text(i-offset-0.08, med, f'{med:.2f}', color='navy',
#                  fontsize=10, ha='right', va='center', fontweight='bold')
#
# # ---- AUPR (右轴) ----
# ax2 = ax1.twinx()
...
#     if len(vals) > 0:
#         med = np.median(vals)
#         ax2.text(i+offset+0.08, med, f'{med:.2f}', color='darkred',
#                  fontsize=10, ha='left', va='center', fontweight='bold')
#
# # ---- X轴 ----
# ax1.set_xticks(x)
...
# ===============================
learning_rates = ['0.001', '0.01', '0.1', '0.5']
base_path = r'C:\Users\胡先俊\Desktop\论文\实验数据\超参数分析\Dis\lr1'
