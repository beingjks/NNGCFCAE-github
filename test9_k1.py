...
# base_path = r'C:\Users\胡先俊\Desktop\论文\实验数据\超参数分析\k1'
#
# auc_data = []
# aupr_data = []
#
# for k in k_values:
#     auc_file = os.path.join(base_path, k, 'AUC--------CSAEtt', 'auc.txt')
#     aupr_file = os.path.join(base_path, k, 'AUC--------CSAEtt', 'aupr.txt')
#
#     # 读取 AUC
...
#                      patch_artist=True, showfliers=False,  # 不显示异常点
...
# # ---- X轴 ----
# ax1.set_xticks(x)
# ax1.set_xticklabels(k_values, fontsize=11)
# ax1.set_xlabel('k1', fontsize=12, labelpad=10)
#
# # ---- 图例（左上方） ----
...
#
# # ---- 标题 ----
# plt.title('representation dimension k1 of GCF', fontsize=14, fontweight='bold')
#
# # ---- 美化 ----
...
# ===============================
k_values = ['32', '64', '128', '256']
base_path = r'C:\Users\胡先俊\Desktop\论文\实验数据\超参数分析\dis\k1'

auc_data = []
aupr_data = []

for k in k_values:
    auc_file = os.path.join(base_path, k,  'auc_summary.txt')
    aupr_file = os.path.join(base_path, k, 'aupr_summary.txt')
...
legend_labels  = ['AUROC', 'AUPR']
ax1.legend(legend_handles, legend_labels, fontsize=12,
           loc='upper left', bbox_to_anchor=(0.05, 1), frameon=True)
